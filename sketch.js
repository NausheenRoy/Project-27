...
bobObject1.shapeColor=color("purple");
bobObject2=new Bob(350,350,50);
bobObject2.shapeColor=color("purple");
bobObject3=new Bob(400,350,50);
bobObject3.shapeColor=color("purple");
bobObject4=new Bob(450,350,50);
bobObject4.shapeColor=color("purple");
bobObject5=new Bob(500,350,50);
bobObject5.shapeColor=color("purple");
